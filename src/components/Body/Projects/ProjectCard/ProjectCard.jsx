...
const ProjectCard = ({ info }) => {
    ...
    const { skills, showProjectLaunch } = info;

    return (
        <div className='project-card-container'>
            <img src={info.projectImage} alt={info.projectName} />
            <span className='project-name'>{info.projectName}</span>
            <span className='project-description'>{info?.projectDescription}</span>

            <div className='project-skill-icons'>
                {skills.map((skill) => {
                    return <span>
                        {
                            skill === "react" && <svg role="img" viewBox="0 0 24 24"
                        ...
                        {
                            skill === "redux" && <svg role="img"
                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                fill='#764ABC' stroke='#764ABC' height="24">
                                <title>Redux</title>
                        ...
                        {
                            skill === "javascript" && <svg role="img"
                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                fill='#F7DF1E' stroke='#F7DF1E' height="24">
                        ...
                        {
                            skill === "tailwindcss" && <svg role="img" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg"
                                fill='#06B6D4' stroke='#06B6D4' height="24">
                        ...
                        {
                            skill === "firebase" && <svg xmlns="http://www.w3.org/2000/svg"
                                x="0px" y="0px" height="24" viewBox="0 0 48 48">
            ...
            {showProjectLaunch && <div className='project-btns'>
                <a className='project-btns-anchor' href={info.projectURL} target='_blank'>
                    <svg xmlns="http://www.w3.org/2000/svg"
                        width="18" height="16" viewBox="0 0 24 24"
                        fill="none" stroke="currentColor" strokeWidth="2"
                        strokeLinecap="round" strokeLinejoin="round"
                        className="lucide lucide-external-link mr-2 h-3 w-3 sm:h-4 sm:w-4">
